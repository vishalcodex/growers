...
import com.codex.growers.fragment.FaqFragment;
import com.codex.growers.fragment.NotificationFragment;
import com.codex.growers.fragment.ProfileFragment;
import com.codex.growers.fragment.ReferEarnFragment;
import com.codex.growers.fragment.WebViewFragment;
import com.codex.growers.helper.ApiConfig;
import com.codex.growers.helper.Constant;
import com.codex.growers.helper.Session;
import com.codex.growers.helper.Utils;
import com.codex.growers.ui.CircleTransform;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (session.isUserLoggedIn()) {
            ...
            Picasso.get()
                    ...
                    .fit()
                    .centerInside()
                    .placeholder(R.drawable.eatfresh)
                    .error(R.drawable.eatfresh)
                    .transform(new CircleTransform())
                    .into(imgProfile);
        }
